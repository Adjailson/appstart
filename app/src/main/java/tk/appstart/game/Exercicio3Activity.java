...
public class Exercicio3Activity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_exercicio3);
        getSupportActionBar().hide();

        grupoPergunta = (RadioGroup) findViewById(R.id.exercicio3);

    }

    public void btPular(View view){
        startActivity(new Intent(this, Exercicio4Activity.class));
        this.finish();
    }
    ...
    public void btEnviar(View view){
        ...
        switch (selecionado){
            case -1:// não selecionou
                ...
                break;
            case R.id.select_1:// resposta certa
