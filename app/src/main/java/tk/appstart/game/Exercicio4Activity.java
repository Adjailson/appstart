...
public class Exercicio4Activity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_exercicio4);
        getSupportActionBar().hide();

        grupoPergunta = (RadioGroup) findViewById(R.id.exercicio4);

    }

    public void btPular(View view){
        startActivity(new Intent(this, Exercicio5Activity.class));
        this.finish();
    }
    ...
    public void btEnviar(View view){
        ...
        switch (selecionado){
            case -1:// não selecionou
                ...
                break;
            case R.id.select_2:// resposta certa
