...
public class Exercicio5Activity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_exercicio5);
        getSupportActionBar().hide();

        grupoPergunta = (RadioGroup) findViewById(R.id.exercicio5);

    }

    public void btPular(View view){
        startActivity(new Intent(this, Exercicio6Activity.class));
        this.finish();
    }
    ...
    public void btEnviar(View view){
        ...
        switch (selecionado){
            case -1:// não selecionou
                ...
                break;
            case R.id.select_3:// resposta certa
